    ...
    while True:
        for i in range(38):
            ...
            for position in lecture_position:
                ...
                pyautogui.hotkey('\n', interval=0.1)
                pyautogui.hotkey('\n')
                """ if screen.getpixel(color_x, color_y+(27*num)) != (255, 255, 255):
                    break """
...
""" print(pyautogui.click())
    ...
    pyautogui.moveTo(450, 45)
    pyautogui.click()
    pyautogui.hotkey('ctrl', 'a')  # ctrl-c to copy
    pyautogui.typewrite('Hello world!', interval=0.1)

    # alert = pyautogui.alert('Alert!') 경고 문구
    # print(alert)

    name = pyautogui.prompt('What is your ID?')
    print(name)
